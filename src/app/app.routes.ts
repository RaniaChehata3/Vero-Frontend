...
export const routes: Routes = [
  ...
  },
  {
    path: 'messages',
    canActivate: [authGuard],
    loadComponent: () => import('./components/messagerie/messagerie.component').then(m => m.MessagerieComponent)
  },
  {
    path: 'community',
  ...
  {
    path: 'petitions',
    loadComponent: () => import('./components/petition/petition').then(m => m.PetitionComponent)
  },
  { path: '**', redirectTo: '' }
];
